  ...
  // },
  {
    ...
    items: [
      ...
      },
      {
        ...
        slug: "sales-invoices",
        path: "/salesinvoice",
        component: () => import("@/pages/salesinvoice"),
      },
      {
        ...
        path: "/invoicereturn",
        component: () => import("@/pages/invoicereturn"),
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        slug: "purchase-bills",
        path: "/purchasebills",
        component: () => import("@/pages/purchasebills"),
      },
      {
    ...
    items: [
      {
        ...
        slug: "groups&ledgers",
        path: "/groups&ledgers",
        component: () => import("@/pages/groups&ledgers"),
      },
      {
        title: "All Entries",
        ...
        slug: "all-entries",
        path: "/all-entries",
        component: () => import("@/pages/allentries"),
      },
    ...
    items: [
      {
        ...
        slug: "profit&loss",
        path: "/profit&loss",
        component: () => import("@/pages/profit&loss"),
      },
      {
        title: "Balance Sheet",
        ...
        slug: "balance-sheet",
        path: "/balance-sheet",
        component: () => import("@/pages/balancesheet"),
      },
      // { title: 'GST Summary', icon: 'mdi-percent-outline', slug: 'gstSummary', path: '/gstsummary', component: () => import('@/pages/gstsummary') },
      {
        ...
        slug: "gstReports",
        path: "/gstreports",
        component: () => import("@/pages/gstreports"),
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        component: () => import("@/pages/role&permission"),
      },
    ],
  },
];
