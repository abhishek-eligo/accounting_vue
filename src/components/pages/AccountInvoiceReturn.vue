              ...
              <VRow>
                <VCol cols="12" lg="6" md="6">
                  ...
                  <VAutocomplete v-model="selectedCustomer" placeholder="Select a customer"
                    ...
                    <template #append>
                      <VBtn class="account_v_btn_outlined" @click="addNewCustomerVisible = true" rounded="2">
                ...
                <VCol cols="12" lg="6" md="6" sm="12">
                  ...
                  <VTextField class="accouting_field accouting_active_field" variant="outlined" :items="statesList" />
                </VCol>
                <VCol cols="12" lg="6" md="6" sm="12">
                  ...
                  <VDataTable :headers="activeInvoiceType === 'item' ? itemInvoiceHeaders : serviceInvoiceHeaders"
                    ...
                    <template #[`item.quantity`]="{ index }">
                      <VTextField v-model="itemInvoiceData[index].quantity"
                        class="accouting_field accouting_active_field" variant="outlined" type="number" placeholder="0"
                        density="compact" />
                    </template>
