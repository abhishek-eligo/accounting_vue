                    ...
                    <VCard class="account_vcard_border" title="New Invoice"
                        ...
                        <template #append>
                            <div class="d-flex align-center gap-2">
                                <VBtn @click="isInvoiceSettingsVisible = true" icon="mdi-cog-outline" variant="text"
                                    size="x-small" rounded="" />
                                <VBtn @click="isCreatingNewInvoice = false" icon="mdi-close" variant="text"
                                    size="x-small" rounded="" class="account_vcard_close_btn" />
                            </div>
                        </template>
                        <VCardText>
                            ...
                            <VRow>
                                <VCol cols="12" lg="6" md="6">
                                    <label class="account_label mb-2">Customer</label>
                                    <VAutocomplete v-model="selectedCustomer" placeholder="Select a customer"
                                        class="accouting_field accouting_active_field" :items="customersList"
                                        variant="outlined">
                                        <template #append>
                                            <VBtn class="account_v_btn_outlined" @click="addNewCustomerVisible = true"
                                                rounded="" icon="mdi-plus-circle-outline" size="x-small" />
                                        </template>
                                    </VAutocomplete>
                                </VCol>
                                <VCol cols="12" lg="6" md="6" sm="12">
                                    <label class="account_label mb-2">Credit Note Number</label>
                                ...
                                <VCol cols="12" lg="6" md="6" sm="12">
                                    ...
                                    <VAutocomplete v-model="placeOfSupply"
                                        class="accouting_field accouting_active_field" variant="outlined"
                                        :items="statesList" />
                                </VCol>
                                <VCol cols="12" lg="6" md="6">
                                    <label class="account_label mb-2">Credit Note Date</label>
                                    <VTextField type="date" class="accouting_field accouting_active_field"
                                        variant="outlined" density="compact" v-model="creditNoteDate" />
                                </VCol>
                                <VCol cols="12" lg="6" md="6">
                                ...
                                <VCol cols="12" lg="6" md="6">
                                    <VRow>
                                        <VCol cols="12" lg="6" md="6" sm="12">
                                            <label class="account_label mb-2">Original Invoice No.</label>
                                            <VTextField
                                                class="accouting_field accouting_active_field" variant="outlined"
                                                density="compact" />
                                        </VCol>
                        ...
                        variant="outlined" density="compact" /> -->
                                            <VTextField v-model="invoiceDate" type="date"
                                                class="accouting_field accouting_active_field" variant="outlined"
                                                density="compact" />
                                        </VCol>
                            ...
                            <VRow>
                                <VCol cols="12" lg="12" md="12">
                                    ...
                                    <VDataTable
                                        :headers="activeInvoiceType === 'item' ? itemInvoiceHeaders : serviceInvoiceHeaders"
                                        ...
                                        <template #[`item.hsn`]="{ index }">
                                            <VTextField
                                                v-model="(activeInvoiceType === 'item' ? itemInvoiceData : serviceInvoiceData)[index].hsnCode"
                                                class="accouting_field accouting_active_field"
                                                variant="outlined"
                                        ...
                                        <template #[`item.quantity`]="{ index }">
                                            <VTextField
                                                v-model="itemInvoiceData[index].quantity"
                                                class="accouting_field accouting_active_field"
                                                variant="outlined"
                                                type="number"
                                                placeholder="0"
                                        ...
                                        <template #[`item.amount`]="{ index }">
                                            <p class="mb-0">₹{{ (activeInvoiceType === 'item' ? itemInvoiceData : serviceInvoiceData)[index].total }}</p>
                                        </template>

                                        <template #[`item.actions`]="{ index }">
                                            <VIcon
                                                icon="mdi-trash-can-outline"
                                                class="cursor-pointer table_row_icon"
                                                :class="{
                                ...
                                <VCol cols="12">
                                    <VBtn class="account_v_btn_outlined mt-3" prepend-icon="mdi-plus-circle-outline"
                                        variant="text" @click="addInvoiceRow(activeInvoiceType)">
                                        Add Another Line
                                    </VBtn>
                                </VCol>
                            </VRow>
                            ...
                            <VRow>
                                ...
                                <VCol cols="12" lg="6" sm="6">
                                    <VRow>
                                        <VCol cols="6"></VCol>
                                        <VCol cols="6">
                                            <VCard class="shadow-none w-100">
                                                <div class="pa-3">
                                                    <div class="d-flex align-center justify-space-between ">
                                                        <span class="account_gst_invoice_subtitle">Subtotal</span>
                                                        <span class="account_gst_invoice_subtitle_val">₹0.00</span>
                                                    </div>
                                                    <div class="d-flex align-center justify-space-between py-2">
                                                        <span class="account_gst_invoice_subtitle">CGST</span>
                                                        <span class="account_gst_invoice_subtitle_val">₹0.00</span>
                                                    </div>
                                                    <div class="d-flex align-center justify-space-between pb-2">
                                                        <span class="account_gst_invoice_subtitle">SGST</span>
                                                        <span class="account_gst_invoice_subtitle_val">₹0.00</span>
                                                    </div>
                                                    <div class="d-flex align-center justify-space-between">
                                                        <span class="account_gst_invoice_subtitle">IGST</span>
                                                        <span class="account_gst_invoice_subtitle_val">₹0.00</span>
                                                    </div>
                                                    <VDivider/>
                                                    <div class="d-flex align-center justify-space-between">
                                                        <span class="account_gst_invoice_subtitle_total">Total Credit Amount</span>
                                                        <span class="account_gst_invoice_subtitle_total_val">₹0.00</span>
                                                    </div>
                                                </div>
                                            </VCard>
                                        </VCol>
                            ...
                            <div class="d-flex align-center gap-2 justify-end mt-3">
                                <VBtn class="account_v_btn_primary" prepend-icon="mdi-content-save-outline">Save Credit Note</VBtn>
                            </div>
        ...
        <v-dialog max-width="900" v-model="addNewCustomerVisible">
            <div v-if="addNewCustomerVisible" class="account_ui_vcard">
                <VCard title="Create a New Customer" class="pa-2 account_vcard_border shadow-none"
                    ...
                    <template #append>
                        <div class="d-flex align-center gap-2">
                            <VMenu location="start" transition="slide-y-transition" offset-y
                                :close-on-content-click="false">
                                <template #activator="{ props }">
                                    <VBtn v-bind="props" icon="mdi-cog-outline" variant="text" size="x-small"
                                        rounded="" />
                                </template>
                                <VCard class="account_vcard_menu account_vcard_border">
                                    ...
                                    <div class="account_vcard_menu_items py-1">
                                        <div v-for="field in formFields" :key="field.key"
                                            class="account_vcard_menu_item" @click="field.visible = !field.visible">
                                            <div
                                                ...
                                                <span :class="field.visible ? '' : 'field_list_dynamic_ml'">{{
                                                    field.label }}</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <VCardText class="add_customer_dialog">
                        <VRow>
                            ...
                            <VCol v-if="isVisible('name')" cols="12" lg="12" md="12">
                                ...
                                <VTextField class="accouting_field accouting_active_field" variant="outlined"
                                    density="compact" placeholder="Customer's Full Name or Company Name" />
                            </VCol>
                            <VCol v-if="isVisible('mobile')" cols="12" lg="5" md="5">
                                <label class="account_label mb-2">Mobile</label>
                                <VTextField class="accouting_field accouting_active_field" type="number"
                                    variant="outlined" density="compact" placeholder="9876543210" />
                            </VCol>
                            <VCol v-if="isVisible('openingBalance')" cols="12" lg="7" md="7">
                                ...
                                <div class="custom_option d-flex align-center">
                                    <VTextField class="custom_option_field accouting_field accouting_active_field"
                                        type="number" variant="outlined" density="compact" placeholder="0" />
                                    <VSelect class="custom_option_select accouting_field accouting_active_field"
                                        v-model="selectedBalanceType" :items="balanceTypeList" variant="outlined"
                                        density="comapct" />
                                </div>
                            </VCol>
                            ...
                            <VCol v-if="isVisible('country')" cols="12" lg="6" md="6">
                                ...
                                <VTextField class="accouting_field accouting_active_field" variant="outlined"
                                    density="compact" placeholder="India" />
                            </VCol>
                            ...
                            <VCol v-if="isVisible('state')" cols="12" lg="6" md="6">
                                <label class="account_label mb-2">Place of Supply</label>
                                <VSelect class="accouting_field accouting_active_field" variant="outlined"
                                    density="compact" placeholder="State" />
                            </VCol>
                            ...
                            <VCol v-if="isVisible('shipToAddress')" cols="12" lg="12" md="12">
                                ...
                                <div class="d-flex align-center justify-end mt-4">
                                    <VBtn class="account_v_btn_primary" prepend-icon="mdi-content-save-outline">Save
                                        Customer</VBtn>
                                </div>
                            </VCol>
                        </VRow>
        ...
        <v-dialog max-width="600" v-model="isInvoiceSettingsVisible">
            <div v-if="isInvoiceSettingsVisible" class="account_ui_vcard">
                <VCard title="Invoice Settings" class="pa-2 account_vcard_border shadow-none"
                    ...
                    <template #append>
                        <VBtn @click="isInvoiceSettingsVisible = false" icon="mdi-close" variant="text" size="x-small"
                        ...
                        <VRow class="acc_invoice_settings_row mx-1">
                            <VCol class="pa-1" cols="3" v-for="tab in settingsTabs" :key="tab">
                                <VBtn size="small" class="w-100"
                                    :class="activeSettingsTab === tab ? 'account_v_btn_light' : 'account_v_btn_ghost'"
                                    variant="text" @click="activeSettingsTab = tab">
                                    {{ tab }}
                                </VBtn>
                            </VCol>
                        </VRow>
                        ...
                        <VRow>
                            <VCol cols="12">
                                <VCard class="account_vcard_border shadow-none pa-4"
                                    v-if="activeSettingsTab === 'Numbering'">
                                    ...
                                    <VRow>
                                                ...
                                                <VCardText class="py-1 px-2">
                                                    <div class="d-flex align-center justify-space-between">
                                                        ...
                                                        <VSwitch density="compact" color="primary" hide-details
                                                            class="account_swtich_btn" inset />
                                                    </div>
                                                </VCardText>
                                            </VCard>
                                        </VCol>
                                        ...
                                        <VCol cols="12" lg="8" md="8">
                                            ...
                                            <VTextField class="accouting_field accouting_active_field"
                                                variant="outlined" density="compact" v-model="prefixType"
                                                :readonly="activePrefixMode === 'Financial Year'" />
                                        </VCol>

                                        <VCol cols="12" lg="4" md="4">
                                            <label class="account_label mb-2">Starting Number</label>
                                            <VTextField class="accouting_field accouting_active_field" type="number"
                                                variant="outlined" density="compact" v-model="startingNumber" />
                                        </VCol>
                                ...
                                <!-- Dummy Cards -->
                                <VCard v-if="activeSettingsTab === 'Columns'"
                                ...
                                <VCard v-if="activeSettingsTab === 'Fields'"
                                    class="account_vcard_border shadow-none pa-4">
                                ...
                                <VCard v-if="activeSettingsTab === 'Mode'"
                                    class="account_vcard_border shadow-none pa-4">
